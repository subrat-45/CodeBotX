...
const Register = () => {
  ...
  return (
    <div className="min-h-screen h-[100vh] flex items-center justify-center bg-gray-900 px-4">
      <div className="w-full max-w-md p-8 bg-gray-800 rounded-2xl shadow-lg">
        ...
        <form className="space-y-6" onSubmit={submitHandler}>
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-xl transition duration-300"
          >
            Register
          </button>
        </form>
